...
\begin{frame}
	...
	\begin{itemize}
		...
		\item Ressources Accessibles et Ressources Acc{\'e}d{\'e}es (suppports de cours, Stack Overflow, ...) ; 
		\item Projets r{\'e}alis{\'e}s, temps pass{\'e}, int{\'e}r{\^e}t {\`a} ce moment ; 
		\item Tutorat pendant le cursus, mentorat et encadrement par la suite, autonomie laiss{\'e}e (ou non) ; 
...
\begin{frame}
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item Gestion m{\'e}moire, Connaissance OS (un ou plusieurs), ... ; 
			\item CyberS{\'e}curit{\'e} (de notions {\`a} expertises) ; 
			\item ... 
		\end{itemize}
		\item ... 
	\end{itemize}
...
\subsection{Pourquoi {\'e}value-t-on ?}
\begin{frame}
	\frametitle{Pourquoi {\'e}value-t-on ?}
	\begin{itemize}
		\item Quels sont les profils possibles ?
		\item Test en un temps limit{\'e} : est-ce repr{\'e}sentatif ?
		\item Repr{\'e}sentativit{\'e} du test du candidat en conditions r{\'e}elles ?
		\item Et la p{\'e}riode d'essai ?
		\item ... 
	\end{itemize}~\\
\end{frame}
